...
// Fallback database mock for standalone client execution
// Use a typed access to globalThis to avoid TS7017
const db = /** @type {{ __B44_DB__?: any }} */ (globalThis).__B44_DB__ || {
